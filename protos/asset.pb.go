...
var file_protos_asset_proto_rawDesc = []byte{
	...
	0x72, 0x4f, 0x66, 0x41, 0x73, 0x73, 0x65, 0x74, 0x73, 0x32, 0x49, 0x0a, 0x05, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x12, 0x40, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x43, 0x68,
...
type AssetClient interface {
	GetAssetChanges(ctx context.Context, in *AssetRequest, opts ...grpc.CallOption) (*AssetResponse, error)
}
...
func (c *assetClient) GetAssetChanges(ctx context.Context, in *AssetRequest, opts ...grpc.CallOption) (*AssetResponse, error) {
	out := new(AssetResponse)
	err := c.cc.Invoke(ctx, "/protos.Asset/GetAssetChanges", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AssetServer interface {
	GetAssetChanges(context.Context, *AssetRequest) (*AssetResponse, error)
}
...
func (*UnimplementedAssetServer) GetAssetChanges(context.Context, *AssetRequest) (*AssetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAssetChanges not implemented")
}
...
func _Asset_GetAssetChanges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssetServer).GetAssetChanges(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Asset/GetAssetChanges",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetServer).GetAssetChanges(ctx, req.(*AssetRequest))
	}
